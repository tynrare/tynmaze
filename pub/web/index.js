...
// end include: /tmp/tmpc50mpkqg.js
...
var ASM_CONSTS = {
  58184: () => { if (document.fullscreenElement) return 1; },  
 58230: () => { return document.getElementById('canvas').width; },  
 58282: () => { return parseInt(document.getElementById('canvas').style.width); },  
 58350: () => { document.exitFullscreen(); },  
 58377: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 58450: () => { if (document.fullscreenElement) return 1; },  
 58496: () => { return document.getElementById('canvas').width; },  
 58548: () => { return screen.width; },  
 58573: () => { document.exitFullscreen(); },  
 58600: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 58733: () => { if (document.fullscreenElement) return 1; },  
 58779: () => { return document.getElementById('canvas').width; },  
 58831: () => { return parseInt(document.getElementById('canvas').style.width); },  
 58899: () => { if (document.fullscreenElement) return 1; },  
 58945: () => { return document.getElementById('canvas').width; },  
 58997: () => { return screen.width; },  
 59022: () => { if (document.fullscreenElement) return 1; },  
 59068: () => { return document.getElementById('canvas').width; },  
 59120: () => { return screen.width; },  
 59145: () => { document.exitFullscreen(); },  
 59172: () => { if (document.fullscreenElement) return 1; },  
 59218: () => { return document.getElementById('canvas').width; },  
 59270: () => { return parseInt(document.getElementById('canvas').style.width); },  
 59338: () => { document.exitFullscreen(); },  
 59365: () => { return screen.width; },  
 59390: () => { return screen.height; },  
 59416: () => { return window.screenX; },  
 59443: () => { return window.screenY; },  
 59470: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 59523: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 59594: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 59651: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 59722: () => { if (document.fullscreenElement) return 1; },  
 59768: () => { if (document.pointerLockElement) return 1; },  
 59815: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 61973: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 62137: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 62241: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 65240: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 65306: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 65699: ($0) => { miniaudio.untrack_device_by_index($0); },  
 65742: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 65867: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
...
var ___start_em_js = Module['___start_em_js'] = 65993;
var ___stop_em_js = Module['___stop_em_js'] = 66066;
